...
<li>You can't pass the "lat" and "long" parameters in directly, but you can pass a comma-delimited latitude, longitude to "vol_loc" and it will be parsed.</li>
<li>This particular query builder parses a CSV file of latitude and longitude, which will be passed in as the "vol_loc" parameter. Thus, you cannot set the vol_loc below; it will be set for you. It also will only show the counts for each of the queries it runs, not the full results.</li></ul>
</div>
<div id="all-for-good-query-form">
<form method="post" action="querycsv.php">
...
<!-- vol_loc is set in the CSV, so don't allow it to be set here -->
