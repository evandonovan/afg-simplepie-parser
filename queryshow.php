<?php 
// Include the AFG parser functions
...
?>
<p>The URL for the query parameters you entered is:</p>
<pre><?php echo $feed_url; ?></pre>
<?php }
  }
?>
<div class="help-info-title" id="help-1"><h2><a href="#help-1">How to 
Use the Query (q) Parameter</h2></a></div>
<div class="help-info">
<ul>
...
<form method="post" action="queryshow.php">
